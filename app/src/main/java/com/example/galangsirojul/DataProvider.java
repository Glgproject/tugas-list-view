package com.example.galangsirojul;
...
import com.example.galangsirojul.model.Anjing;
import com.example.galangsirojul.model.Hewan;
import com.example.galangsirojul.model.Kucing;
import com.example.galangsirojul.model.Bebek;
...
public class DataProvider {
    ...
    private static List<Bebek> initDataBebek(Context ctx) {
        List<Bebek> bebeks = new ArrayList<>();
        bebeks.add(new Bebek("Aylesbury", "Inggris",
                "Bebek populer yang dikenal dengan badan yang gemuk berotot, wajah seperti kain kusut, dan hidung yang pesek", R.drawable.bebek_aylesbury));
        bebeks.add(new Bebek("Manila", "Alaska,Siberia,Finlandia (daerah bersalju) ",
                "Bebek jenis khusus yang awalnya digunakan untuk menarik kereta salju", R.drawable.bebek_manila));
        bebeks.add(new Bebek("Swedia", "Indonesia",
                "Ras bebek asli pulau Bali ", R.drawable.bebek_swedia));
        bebeks.add(new Bebek("Mojosari", "Rusia",
                "Bebek yang berasal dari Siberia yang awalnya biasa digunakan untuk menjaga ternak oleh suku Samoyed", R.drawable.bebek_mojosari));
        bebeks.add(new Bebek("Peking", "Jerman",
                "Bebek pintar dan kuat, sekarang banyak digunakan sebagai anjing penjaga, pengawal, dan anjing polisi (K9)", R.drawable.bebek_peking));
        bebeks.add(new Bebek("Rouen", "Jepang",
                "Bebek dari daerah Shiba ini gesit dan lincah sehingga awalnya banyak digunakan untuk berburu ", R.drawable.bebek_rouen));
        return bebeks;
    }
    ...
    private static void initAllHewans(Context ctx) {
        ...
        hewans.addAll(initDataBebek(ctx));
    }
